...
(coalton-toplevel
  ...
  (declare loop-while-val ((Monad :m) (Yielder :y) => :m (:y :a) -> (:a -> :m :b) -> :m Unit))
  (define (loop-while-val m-operation f)
